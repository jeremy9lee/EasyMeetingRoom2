			...
			<c:choose>
				<c:when test="${empty requestScope.building }">
					<tr>
						<td >${sessionScope.employee.empName}님 안녕하세요!
							<button type="submit" class="btn btn-info">로그아웃</button> <c:choose>
				...
				<c:otherwise>
					<tr >
						...
						<td rowspan = "2">&nbsp;<img src="./img/${building.buildingImg }"
							style="height: 100px" />
						<td>
					</tr>
					<tr >
						<td><small>${building.buildingName }
							-&nbsp;${listSize}개의 회의실 보유</small></td>
					</tr>
				</c:otherwise>
			</c:choose>
		</table>
